...
SWIGINTERN PyObject *_wrap_fdt_get_mem_rsv(PyObject *self, PyObject *args) {
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "fdt_get_mem_rsv", 4, 4, swig_obj)) SWIG_fail;
  {
    if (!PyByteArray_Check(swig_obj[0])) {
...
static swig_type_info _swigt__p_int = {"_p_int", "fdt32_t *|int32_t *|int_fast16_t *|int_fast32_t *|int_least32_t *|intptr_t *|int *", 0, 0, (void*)0, 0};
