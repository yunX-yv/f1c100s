...
BEGIN {
    ...
    require '/home/xiao/project/f1c100s/SDK/app/3rd_lib/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/xiao/project/f1c100s/SDK/app/3rd_lib/openssl/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/home/xiao/project/f1c100s/SDK/app/3rd_lib/openssl/test/default-and-jitter.cnf';
    shift;
